                   ...
                   ?>
                            ...
                            <div class="col-md-8">
                                <div class="inner-content clearfix">
                                    ...
                                    <a class='read-more pull-right' href='update_post.php?id=<?php echo $data['post_id'] ?>'>Update</a>
                                    <a onclick="return confirm ?" class='read-more pull-right' href='delete_post.php?id=<?php echo $data['post_id'] ?>'>Delete</a>
